                  ...
                  {wedingDetails.partner1.sentRing || (
                    <div className="flex flex-row">
                      ...
                      <div className="basis-1/2 text-center">
                        ...
                        <p>
                          You can create your own ring by uploading any image of
                          your choice and we will mint it as an NFT which will
                          remain on block chain forever{" "}
                        </p>
                        <div className="m-6 flex items-center justify-center">
                          <button
          ...
          <div className="flex flex-row">
            ...
            <div>
              {wedingDetails.status == 2 && (
                <button onClick={sendRing}>Start The wedding</button>
              )}
