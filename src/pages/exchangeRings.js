...
const Wedding =() =>{
    ...
    const fetchWedding = async () =>{
            try{
                ...
                accountAddress = currentAccount[0]
                ...
                console.log(wedingDetails.partner2.sentRing &&
                    ...
                    console.log(currentAccount[0]+ 'oioioi' + wedingDetails.partner1.address)
            }
            catch(err){
            }
    }
        ...
        <div>
          ...
          <div className='flex flex-row'>
            ...
            <p>Vows</p>
             ...
             {( (accountAddress == wedingDetails.partner1.address && !wedingDetails.partner1.sentRing) || 
                (accountAddress == wedingDetails.partner2.address && !wedingDetails.partner2.sentRing)) && 
             <div>
                <button onClick={sendRing}>Send ring</button>
            </div>}
