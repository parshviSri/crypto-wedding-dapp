...
const ViewWedding = () => {
  ...
  const [wedding1, setWedding1] = useState({ partner1Name: "", partner2Name: "" });
  const [wedding2, setWedding2] = useState({ partner1Name: "", partner2Name: "" });
  const [wedding3, setWedding3] = useState({ partner1Name: "", partner2Name: "" });
  const [wedding4, setWedding4] = useState({ partner1Name: "", partner2Name: "" });
  const [wedding5, setWedding5] = useState({ partner1Name: "", partner2Name: "" });
  ...
  return (    
    <div className="flex flex-row">
        {weddings.map((wedding,id)=>{
            ...
            <div class="px-6 py-4">
                <button onClick={()=>{router.push({pathname:'/wedding' , query: { id:id+1}})}}>
